...
// Script para poblar la Knowledge Base con los documentos iniciales
...
async function seed() {
  ...
  for (const doc of KNOWLEDGE_DOCUMENTS) {
    ...
    // 3. Crear Chunk para cada documento (1 chunk = 1 documento por ahora)
  ...
  console.log(`\n✅ ${KNOWLEDGE_DOCUMENTS.length} documentos insertados en Knowledge Base`);
}
